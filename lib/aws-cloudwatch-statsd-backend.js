...
CloudwatchBackend.prototype.flush = function(timestamp, metrics) {
  ...
  for (key in counters) {
    ...
    console.log('this.config.processKeyForNamespace:' + this.config.processKeyForNamespace);
    console.log('metricName: ' + metricName + ', namespace: ' + namespace + ', dimensions: ' + dimensions);
